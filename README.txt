The program implements a software system that uses an interactive menu-driven Text-Based User Interface to allow the user to create and manage a list of text lines entered via keyboard or loaded from text files.
...
o	practice text input / output file processing
o	write a C++ class template